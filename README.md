...
An interactive closet planner built with Next.js and React Three Fiber. Place, move, and configure closet components in both 2D and 3D views, with a Prisma-backed persistence layer for saving and versioning designs.
